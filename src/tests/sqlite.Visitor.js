...
exports["sqlite.Visitor: IsEqualTo."] = () => {
    ...
    assert(statement, "SELECT 'Source'.'id' AS 'Source___id', 'Source'.'string' AS 'Source___string', 'Source'.'number' AS 'Source___number', 'Source'.'date' AS 'Source___date', 'Source'.'boolean' AS 'Source___boolean', 'Source'.'float' AS 'Source___float' FROM 'Source' WHERE ('Source'.'string' = 'Hello World') LIMIT -1 OFFSET 0");
}
