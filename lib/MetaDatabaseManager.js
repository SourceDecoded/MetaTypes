...
var MetaDatabaseManager = function () {
    function MetaDatabaseManager() {
        ...
        _classCallCheck(this, MetaDatabaseManager);
    ...
    _createClass(MetaDatabaseManager, [{
    ...
    return MetaDatabaseManager;
}();

exports.default = MetaDatabaseManager;
//# sourceMappingURL=MetaDatabaseManager.js.map