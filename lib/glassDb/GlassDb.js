...
var _class = function () {
    ...
    _createClass(_class, [{
        ...
        value: function dispose() {
            ...
            this.glassPanes.forEach(function (pane) {
                pane.dispose();
            });
        }
    }, {
        ...
        value: function addEdmAsync(name, version) {
            ...
            return this._driver.addEdmAsync(name, version).then(function () {
                return _this2._driver.getEdmAsync(name, version);
            }).then(function (edm) {
                _this2._buildPaneAsync(edm);
            }).then(function (pane) {
                Object.keys(_this2.glassDoors).map(function (key) {
                    return _this2.glassDoors[key];
        ...
        value: function deleteEdmAsync(name, version) {
            ...
            return this._driver.deleteEdmAsync(name, version).then(function () {
                _this3.glassPanes[name + version] = null;
            });
        }
    }, {
        ...
        value: function _buildPaneAsync(edm) {
            ...
            return driver.getDatabaseForEdmAsync(edm).then(function (db) {
                ...
                _this4.glassPanes[edm.name + edm.version] = pane;
                return pane;
            });
        }
    }, {
        ...
        value: function _openDoorsAsync(doorsConfig) {
            ...
            doorsConfig.forEach(function (doorConfig) {
                doorConfig.options['glass'] = _this5;
                var door = new supportedDoors[doorConfig.name](doorConfig.options);
                Object.keys(_this5.glassPanes).map(function (key) {
                    return _this5.glassPanes[key];
                }).forEach(function (pane) {
                    door.addPane(pane);
                });
                _this5.glassDoors.push(door);
            });
        }
    }]);
