...
var Provider = function () {
    ...
    _createClass(Provider, [{
        ...
        value: function _refineInnerQueriesAsync(queryable) {
            ...
            return innerQueries.reduce(function (queryableExpression) {
                var query = queryableExpression.value;
                var queryable = new _queryablejs.Queryable(query.type, query);
                var provider = _this.metaDatabase.getTable(query.type).getQueryProvider(_this.user);
            }, _queryablejs.Queryable).then(function () {
                return queryable;
            });
        }
    }, {
