...
var MetaTable = function () {
    ...
    _createClass(MetaTable, [{
        ...
        value: function getWriteStreamByIdAsync(user, id) {
            ...
            return this.getEntityByIdAsync(user, id).then(function (entity) {
                var filePath = _this10._getFilePathById(id);
                var writable = _this10.fileSystem.getWriteStreamAsync(filePath);

                writable.on("end", function () {
                    _this10._invokeMethodWithRecoveryOnDecoratorsAsync("fileUpdatedAsync", [id, filePath]);
                });
