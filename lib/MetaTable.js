...
var MetaTable = function () {
    ...
    _createClass(MetaTable, [{
        ...
        key: "getFileByIdAsync",
        value: function getFileByIdAsync(user, id) {}
    }, {
        ...
        key: "saveFileByIdAsync",
        value: function saveFileByIdAsync(user, id, stream) {}
    }, {
        ...
        value: function updateEntityAsync(user, entity, delta) {
            ...
            return this._prepareEntityToBeUpdatedAsync(user, entity, delta).then(function (delta) {
                ...
                return _this9._entityUpdatedAsync(user, updatedEntity, delta);
            }).then(function () {
