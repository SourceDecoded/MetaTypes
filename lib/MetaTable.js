...
var MetaTable = function () {
    ...
    _createClass(MetaTable, [{
        ...
        value: function _invokeMethodWithRecoveryOnDecoratorsAsync(user, method, args) {
            var _this4 = this;
        ...
        key: "getReadStreamByIdAsync",
        value: function getReadStreamByIdAsync(user, id) {
            var _this8 = this;

            return getEntityByIdAsync(user, id).then(function (entity) {
                return _this8.fileSystem.getReadStreamAsync(_this8._getFilePathById(id));
            });
        }
    }, {
        key: "getWriteStreamByIdAsync",
        value: function getWriteStreamByIdAsync(user, id) {
            var _this9 = this;

            return getEntityByIdAsync(user, id).then(function (entity) {
                return _this9.fileSystem.getWriteStreamAsync(_this9._getFilePathById(id));
            });
        }
    }, {
        ...
        value: function removeEntityAsync(user, entity) {
            ...
            return this._approveEntityToBeRemovedAsync(user, entity).then(function () {
                return _this10.removeFileByIdAsync(user, entity[_this10._getPrimaryKeyName()]).catch(function (error) {
                    return;
                });
            }).then(function () {
                return _this10.table.removeEntityAsync(entity);
            }).then(function () {
                return _this10._entityRemovedAsync(user, entity);
            });
        }
    }, {
        ...
        value: function removeFileByIdAsync(user, id) {
            ...
            return this.getEntityByIdAsync(user, id).then(function () {
                return _this11.fileSystem.removeFileAsync(_this11._getFilePathById(id));
            });
        }
    }, {
        ...
        value: function updateEntityAsync(user, entity, delta) {
            ...
            return this._prepareEntityToBeUpdatedAsync(user, entity, delta).then(function (delta) {
                return _this12._validateEntityToBeUpdatedAsync(user, entity, delta);
            }).then(function (delta) {
                return _this12.table.updateEntityAsync(user, entity, delta).then(function (entity) {
                    updatedEntity = entity;
                    return delta;
                });
            }).then(function (delta) {
                return _this12._entityUpdatedAsync(user, updatedEntity, delta);
            }).then(function () {
