    ...
    _createClass(Queryable, [{
        ...
        value: function or(lambda) {
            ...
            if (typeof lambda === "function") {
                ...
                rightExpression = lambda.call(_ExpressionBuilder2.default, new _ExpressionBuilder2.default(this.Type));
            ...
            if (query.where.children.length === 0) {
                ...
                query.where.children.push(_Expression2.default.or(leftExpression, rightExpression));
            }
        ...
        value: function where(lambda) {
            ...
            if (query.where.children.length === 0) {
                ...
                var leftExpression = query.where.children.pop();
                query.where.children.push(_Expression2.default.and(leftExpression, rightExpression));
            }
        ...
        value: function take(value) {
            ...
            var query = copyQuery(this.getQuery());
            query.take = _Expression2.default.take(value);
        ...
        value: function skip(value) {
            ...
            var query = copyQuery(this.getQuery());
            query.skip = _Expression2.default.skip(value);
        ...
        value: function orderByDesc(lambda) {
            var query = copyQuery(this.getQuery());
            var propertyExpression = lambda.call(_ExpressionBuilder2.default, new _ExpressionBuilder2.default(this.Type)).getExpression();

            var descendingExpression = _Expression2.default.descending(propertyExpression);
        ...
        value: function orderBy(lambda) {
            ...
            if (typeof lambda === "function") {
                lambda = lambda || function () {};
                propertyExpression = lambda.call(_ExpressionBuilder2.default, new _ExpressionBuilder2.default(this.Type)).getExpression();
            ...
            var ascendingExpression = _Expression2.default.ascending(propertyExpression);
        ...
        value: function include(lambda) {
            ...
            if (propertyExpression.nodeName !== "queryable") {
                propertyExpression = _Expression2.default.queryable(propertyExpression, _Expression2.default.expression(_Expression2.default.where()));
            }
        ...
        value: function merge(queryable) {
            ...
            if (rightExpression != null) {
                ...
                if (cloneQuery.where.children.length === 0) {
                    ...
                    cloneQuery.where.children.push(_Expression2.default.and(leftExpression, rightExpression.copy()));
                }
            }
        ...
        value: function toGuid(value) {
            return _Expression2.default.guid(_Expression2.default.constant(value));
        }
    }, {
        key: "forEach",
