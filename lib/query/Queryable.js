...
var Queryable = function () {
    ...
    _createClass(Queryable, [{
        ...
        value: function include(lambda) {
            ...
            var operationExpressionBuilder = lambda.call(_ExpressionBuilder2.default, new _ExpressionBuilder2.default(this.Type));
            ...
            if (queryableExpression.nodeName !== "queryable") {
                queryableExpression = _Expression.Expression.queryable(queryableExpression, _Expression.Expression.expression(_Expression.Expression.where()));
            }
