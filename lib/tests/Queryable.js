...
exports["Queryable: Constructor with toArrayAsync called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { execute: function execute() {
...
exports["Queryable: Constructor with forEach called."] = function () {
    ...
    queryable.forEach(function () {}).then(function () {
        assert.ok(true);
    });
};
...
exports["Queryable: Constructor with count called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { count: function count(queryable) {
            return 1;
        } };
...
exports["Queryable: Constructor with toArrayWithCount called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { toArrayWithCount: function toArrayWithCount(queryable) {
            return 1;
        } };

    var count = queryable.toArrayWithCount();
    assert.equal(1, count);
};

exports["Queryable: Constructor with all called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { all: function all(lambda) {
            return true;
        } };

    var all = queryable.all();
    assert.ok(all);
};

exports["Queryable: Constructor with any called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { any: function any(lambda) {
            return true;
        } };
...
exports["Queryable: Constructor with firstOrDefault called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { firstOrDefault: function firstOrDefault(lambda) {
            return true;
        } };
...
exports["Queryable: Constructor with lastOrDefault called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { lastOrDefault: function lastOrDefault(lambda) {
            return true;
        } };

    var lastOrDefault = queryable.lastOrDefault();
    assert.ok(lastOrDefault);
};

exports["Queryable: Constructor with first called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { first: function first(lambda) {
            return true;
        } };
...
exports["Queryable: Constructor with last called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { last: function last(lambda) {
            return true;
        } };

    var last = queryable.last();
    assert.ok(last);
};

exports["Queryable: Constructor with select called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { select: function select(lambda) {
            return true;
        } };
...
exports["Queryable: Constructor with contains called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { contains: function contains(lambda) {
            return true;
        } };

    var contains = queryable.contains();
    assert.ok(contains);
};
