...
exports["Queryable: Constructor with toArrayAsync called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { executeAsync: function executeAsync() {
...
exports["Queryable: Constructor with toGuid called."] = function () {
    ...
    var guidExpression = queryable.toGuid(12345);
...
exports["Queryable: Constructor with forEachAsync called."] = function () {
    ...
    queryable.forEachAsync(function () {}).then(function () {
        assert.ok(true);
    });
};
...
exports["Queryable: Constructor with allAsync called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { allAsync: function allAsync(lambda) {
            return Promise.resolve();
        } };

    queryable.allAsync().then(function () {
        assert.ok(true);
    });
};
...
exports["Queryable: Constructor with anyAsync called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { anyAsync: function anyAsync(lambda) {
            return Promise.resolve();
        } };

    queryable.anyAsync().then(function () {
        assert.ok(true);
    });
};
...
exports["Queryable: Constructor with firstOrDefaultAsync called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { firstOrDefaultAsync: function firstOrDefaultAsync(lambda) {
            return Promise.resolve();
        } };

    queryable.firstOrDefaultAsync().then(function () {
        assert.ok(true);
    });
};
...
exports["Queryable: Constructor with firstAsync called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { firstAsync: function firstAsync(lambda) {
            return Promise.resolve();
        } };

    queryable.firstAsync().then(function () {
        assert.ok(true);
    });
};
...
exports["Queryable: Constructor with lastAsync called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { lastAsync: function lastAsync(lambda) {
            return Promise.resolve();
        } };

    queryable.lastAsync().then(function () {
        assert.ok(true);
    });
};
...
exports["Queryable: Constructor with selectAsync called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { selectAsync: function selectAsync(lambda) {
            return Promise.resolve();
        } };

    queryable.selectAsync().then(function () {
        assert.ok(true);
    });
};
...
exports["Queryable: Constructor with containsAsync called."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { containsAsync: function containsAsync(lambda) {
            return Promise.resolve();
        } };

    queryable.containsAsync().then(function () {
        assert.ok(true);
    });
};
...
exports["Queryable: Constructor with ifNone called (with value === 0)"] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { countAsync: function countAsync(lambda) {
            return Promise.resolve(0);
        } };

    queryable.ifNone(function () {
...
exports["Queryable: Constructor with ifAny called (with value.length === 0)"] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { executeAsync: function executeAsync(lambda) {
            return Promise.resolve([]);
        } };
...
exports["Queryable: Constructor with intersects called with queryable passed in."] = function () {
    var queryable1 = new _Queryable2.default();
    var queryable2 = new _Queryable2.default();
    queryable1.provider = { intersectsAsync: function intersectsAsync() {
            return Promise.resolve();
        } };

    queryable1.intersectsAsync(queryable2).then(function () {
        assert.ok(true);
    });
};
...
exports["Queryable: Constructor with intersects called with array passed in."] = function () {
    var queryable = new _Queryable2.default();
    queryable.provider = { intersectsAsync: function intersectsAsync() {
            return Promise.resolve();
        } };
    ...
    var compareToQueryable = [];

    queryable.intersectsAsync(compareToQueryable).then(function () {
        assert.ok(true);
    });
};
