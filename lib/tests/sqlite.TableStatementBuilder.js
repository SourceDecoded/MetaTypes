...
exports["TableStatementBuilder.createTableStatement: With Relationships."] = function () {
    ...
    assert.equal(tableStatement, "CREATE TABLE IF NOT EXISTS \"Foreign\" (\"id\" INTEGER PRIMARY KEY AUTOINCREMENT, \"foreignKey\" INTEGER)");
};
...
exports["TableStatementBuilder.createAddColumnStatement"] = function () {
    var builder = new _TableStatementBuilder2.default();
...
//# sourceMappingURL=sqlite.TableStatementBuilder.js.map