        ...
        value: function createCommandsFromEdm(edm) {
            ...
            var commands = edm.tables.reduce(function (accumulator, table) {
                ...
                table.columns.forEach(function (column) {
                    accumulator.push(_this.createAddColumnCommand(table.name, column));
                });

                return accumulator;
            }, []);

            edm.relationships.oneToOne.reduce(function (accumulator, relationship) {
                accumulator.push(_this.createAddOneToOneRelationshipCommand(relationship));
                return accumulator;
            }, commands);

            edm.relationships.oneToMany.reduce(function (accumulator, relationship) {
                accumulator.push(_this.createAddOneToManyRelationshipCommand(relationship));
                return accumulator;
            }, commands);
