...
var TableStatementBuilder = function () {
    ...
    _createClass(TableStatementBuilder, [{
        ...
        value: function createUpdateStatement(entity, delta) {
            ...
            this.filterRelevantColumns(columns).forEach(function (column, index) {
                var columnName = column.name;

                if (typeof delta[columnName] !== "undefined" && _this2.dataTypeMapping[column.type] != null) {
                    columnSet.push(_this2._escapeName(columnName) + ("=@v" + index));
        ...
        value: function createDeleteStatement(entity) {
            ...
            primaryKeys.forEach(function (primaryKey, index) {
                ...
                if (entity[primaryKey] === null) {
                    ...
                    primaryKeysExpr.push(_this3._escapeName(primaryKey) + " @k" + index);
                    values.push(_this3.toMssqlValue(entity[primaryKey]));
                }
            });
