...
var Migrator = function () {
    function Migrator(edmPoolPromise) {
        _classCallCheck(this, Migrator);

        this._edmPoolPromise = edmPoolPromise;
        this._tableStatementBuilder = new _TableStatementBuilder2.default();
    }

    _createClass(Migrator, [{
        key: "_executeAsync",
        value: function _executeAsync(query) {
            this._edmPoolPromise.then(function (pool) {
