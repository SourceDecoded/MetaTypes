...
var Database = function () {
    function Database() {
        ...
        var connectionPool = options.connectionPool;
        var edm = options.edm;
    ...
    _createClass(Database, [{
        ...
        value: function _createTables() {
            ...
            this.edm.tables.forEach(function (table) {
                return _this._createTable(table);
            });
        }
    }, {
        key: "_createTable",
        value: function _createTable(table) {
            ...
            this.tables[table.name] = new _Table2.default(table.name, options);
        }
    }, {
        ...
        value: function createAsync() {
            ...
            return buildOrder.reduce(function (promise, table) {
                return promise.then(function () {
                    var mssqlTable = _this4.tables[table.name];
        ...
        value: function dropAsync() {
            ...
            return buildOrder.reduce(function (promise, table) {
                return promise.then(function () {
                    var mssqlTable = _this5.tables[table.name];
