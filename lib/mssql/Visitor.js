...
var Visitor = function (_ExpressionVisitor) {
    ...
    _createClass(Visitor, [{
        ...
        value: function createSelectStatement(query) {
            ...
            queryParts.push("SELECT " + columnAliases + " FROM " + this._escapeIdentifier(this.schema + "." + this.table.name), joinClause, where, orderBy, take, skip);
        ...
        value: function makeColumnAliases(map) {
            ...
            map.forEach(function (table) {
                ...
                table.columns.forEach(function (column) {
                    ...
                    columns.push(_this5._escapeIdentifier(_this5.schema + "." + tableName) + "." + _this5._escapeIdentifier(columnName) + " AS " + _this5._escapeIdentifier(tableName + "___" + columnName));
                });
            });
