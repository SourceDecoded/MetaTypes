...
var Table = function () {
    function Table(name) {
        ...
        this.tableStatementBuilder = new _TableStatementBuilder2.default(table, options);
    ...
    _createClass(Table, [{
        ...
        value: function addEntityAsync(entity) {
            ...
            return this.mssqlDatabase.request().query(sql.statement, sql.values).then(function (result) {
        ...
        value: function removeEntityAsync(entity) {
            ...
            return this.mssqlDatabase.request().query(sql.statement, sql.values).then(function () {
                return entity;
            });
        }
    }, {
        ...
        value: function updateEntityAsync(entity, delta) {
            ...
            return this.mssqlDatabase.request().query(sql.statement, sql.values).then(function (statement) {
