...
var Table = function () {
    ...
    _createClass(Table, [{
        ...
        value: function addEntityAsync(entity) {
            ...
            return this.sqlite.run(sql.statement, sql.values).then(function (statement) {
                entity[_this._getPrimaryKeyName()] = statement.lastID;
                return entity;
            });
        }
    }, {
        ...
        value: function removeEntityAsync(entity) {
            ...
            return this.sqlite.run(sql.statement, sql.values).then(function () {
                return entity;
            });
        }
    }, {
