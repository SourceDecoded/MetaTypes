...
var _ExpressionVisitor2 = require("./../query/ExpressionVisitor");

var _ExpressionVisitor3 = _interopRequireDefault(_ExpressionVisitor2);
...
var Visitor = function (_ExpressionVisitor) {
    ...
    _createClass(Visitor, [{
        ...
        value: function createSelectStatement(query) {
            ...
            queryParts.push("SELECT " + columnAliases + " FROM " + this._escape(this.table.name), joinClause, where, orderBy, take, skip);
        ...
        value: function makeColumnAliases(map) {
            ...
            map.forEach(function (table) {
                ...
                table.columns.forEach(function (column) {
                    ...
                    columns.push(_this5._escape(tableName) + "." + _this5._escape(columnName) + " AS " + _this5._escape(tableName + "___" + columnName));
                });
            });
