...
var TableStatementBuilder = function () {
    ...
    _createClass(TableStatementBuilder, [{
        ...
        value: function _createColumnDefinition(tableName, column) {
        ...
        key: "createAddColumnStatement",
        value: function createAddColumnStatement(tableName, column) {
            var columnDefinition = this._createColumnDefinition(tableName, column);
        ...
        key: "createUpdateColumnTransaction",
        value: function createUpdateColumnTransaction(table, previousColumn, newColumn) {}
    }, {
        ...
        value: function createColumnDefinitionStatement(tableName, column) {
        ...
        value: function createColumnsDefinitionStatement(table) {
            ...
            var columnDefinitions = columns.map(function (column) {
                return _this4.createColumnDefinitionStatement(table.name, column);
